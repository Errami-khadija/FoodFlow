   ...
   <div id="cart-sidebar" class="fixed top-0 right-0 h-full w-full sm:w-96 bg-white shadow-2xl z-50 transform translate-x-full transition-transform duration-300">
    <div class="flex flex-col h-full">
     ...
     <div class="p-6 border-t bg-gray-50">
      ...
      <a href="{{ route('checkout') }}"  id="checkout-btn" class="w-full flex items-center justify-center py-4 bg-gradient-to-r from-primary to-secondary text-white rounded-xl font-bold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed" disabled> Proceed to Checkout </a>
     </div>
    </div>
   </div>
