     ...
     <div class="flex items-center justify-between">
      <div class="flex items-center gap-4">
       <!-- Mobile Menu Button --> <button onclick="toggleMobileMenu()" class="lg:hidden p-2 rounded-lg hover:bg-gray-100">
        ...
        <div>
            <h2  class="text-xl lg:text-2xl font-bold text-gray-900"> FoodFlow Super Admin</h2>
            <p class="text-sm text-gray-400"> Welcome back, Super Admin </p>
</div>
      </div>
      <div class="flex items-center gap-3 lg:gap-4">
      <!-- Notifications --> <button class="relative p-2 rounded-xl hover:bg-gray-100">
        <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewbox="0 0 24 24">
